...
public class SavedBlock {
	...
	public SavedBlock(JSONObject savedBlockData) {
		...
		this.isAttachable = ((Boolean) savedBlockData.get("is-attachable")).booleanValue();
	}
	...
	public JSONObject toJSON() {
		...
		savedBlockData.put("data", Byte.valueOf(this.data));
		savedBlockData.put("relative-x", Integer.valueOf(this.relativeX));
		savedBlockData.put("relative-y", Integer.valueOf(this.relativeY));
		savedBlockData.put("relative-z", Integer.valueOf(this.relativeZ));
		savedBlockData.put("is-attachable", Boolean.valueOf(this.isAttachable));
